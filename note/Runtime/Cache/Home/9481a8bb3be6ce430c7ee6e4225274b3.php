...
<body>
<h1>修改</h1>
<?php if(is_array($editNote)): $i = 0; $__LIST__ = $editNote;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><div id='send-form'>
		<form method="post" action="/note/index.php/Home/Note/updateNote" name='fmNote'>
			...
			<p>
				...
				<br />
				<textarea style="height:100px; width:370px;" name="content" id='content'><?php echo ($item["content"]); ?></textarea> 
				<div id='phiz'>
